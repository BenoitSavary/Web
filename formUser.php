...
<form>
    <div class="form">
            ...
            <div class="separation"></div>
            <h3> Renseigner les identifiants de l'utilisateur : </h3>
             <div class="form">
            <div class="group">
  ...
  <h3> Renseigner les identifiants de l'utilisateur : </h3>
         <div class="form">
            <div class="group">
                ...
                <select  >
                <option value="test">--Selectionner un centre-- </option>
                </select>
            </div>
            <div class="group">
                <label> Promotion attribué* </label>
                <select  >
                <option value="test">--Sélectionner une promotion-- </option>
                </select>
            </div>
            ...
            <div class="group">
                ...
                <select  >
                <option value="test">--Séléctionner un statut-- </option>
                </select>
            </div>
...
<fieldset>
<legend> [cocher pour autorisé]</legend>
